...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (pid == 0){
            ...
            unsigned long cwnd = 80, duplicateACK = 0, duplicateTrigger = 3;
            unsigned long seqNum = 1, ACKnum = 0, errors = 0, retransmits = 0, nFrags, ACK, RTO= 500, sent = 0;
            ...
            for(unsigned char fin=0; fin<20; fin++){
